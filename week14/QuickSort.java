public class QuickSort {
  ...
  static int partition(int[] arr, int left, int right) {
    ...
    while (true) {
      ...
      // if the two indices cross each other, break out of the big
      // while loop -- no swapping because it's time to swap the pivot.
      if (i >= j) { break; }

      // if you didn't break out above, swap your i and j values above
    ...
    // Finally, when i and j have crossed, swap the pivot value (left)
